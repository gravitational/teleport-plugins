...
2. Install [`protoc-gen-terraform`](https://github.com/gravitational/protoc-gen-terraform) v1.4.2.

    ```go install github.com/gravitational/protoc-gen-terraform@v1.4.2```
