...
// providerConfigure accepts a provider settings schema,
// initializes a Teleport Client and returns it.
func providerConfigure(d *schema.ResourceData) (interface{}, error) {
	...
	tlsConfig, err := access.LoadTLSConfig(certPath, keyPath, rootCAsPath)
	if err != nil {
		return nil, trace.Wrap(err)
	}
