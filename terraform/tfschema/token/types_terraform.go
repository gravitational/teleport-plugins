					...
					Attributes: github_com_hashicorp_terraform_plugin_framework_tfsdk.SingleNestedAttributes(map[string]github_com_hashicorp_terraform_plugin_framework_tfsdk.Attribute{
						"allow": {
							Attributes: github_com_hashicorp_terraform_plugin_framework_tfsdk.ListNestedAttributes(map[string]github_com_hashicorp_terraform_plugin_framework_tfsdk.Attribute{
								...
								"environment_protected": GenSchemaBoolOptionFixed(ctx),
								"namespace_path": {
								...
								"ref_protected": GenSchemaBoolOptionFixed(ctx),
								"ref_type": {
														...
														if !ok {
															...
															if !v.Null && !v.Unknown {
																...
																}
																{
																	...
																	CopyFromBoolOptionFixed(diags, a, &obj.RefProtected)
																}
																{
																	...
																	CopyFromBoolOptionFixed(diags, a, &obj.EnvironmentProtected)
																}
																{
														...
														if a == nil {
															...
															}
															{
																...
																if !ok {
																	...
																	v := CopyToBoolOptionFixed(diags, obj.RefProtected, t, tf.Attrs["ref_protected"])
															...
															}
															{
																...
																if !ok {
																	...
																	v := CopyToBoolOptionFixed(diags, obj.EnvironmentProtected, t, tf.Attrs["environment_protected"])
