...
func SetupIndexes(ctx context.Context, cache cache.Cache) error {
	return trace.Wrap(
		cache.IndexField(ctx, &authv10.Identity{}, "spec.secretName", kclient.IndexerFunc(func(obj kclient.Object) []string {
			return []string{obj.(*authv10.Identity).Spec.SecretName}
		})),
	)
}
