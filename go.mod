...
replace (
	...
	github.com/gravitational/teleport => github.com/gravitational/teleport v0.0.0-20240216204833-520f79d46f94 // ref: tags/v15.0.2
	github.com/gravitational/teleport/api => github.com/gravitational/teleport/api v0.0.0-20240216204833-520f79d46f94 // ref: tags/v15.0.2
